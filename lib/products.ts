...
export const products: Product[] = [
  {
    ...
    description: {
      ...
      kh: 'ថាមពលបំបាត់ការឈឺចាប់។ ការបំបាត់ការឈឺចាប់គ្រប់បែបយ៉ាង សម្រាប់ការឈឺចាប់ប្រចាំថ្ងៃ។'
    },
    ingredients: [
      'Coconut Oil',
      'White Beeswax',
  ...
  },
  {
    ...
    description: {
      ...
      kh: 'ធម្មជាតិត្រជាក់។ ត្រជាក់និងសុខស្រួលតាមរយៈថាមពលត្រជាក់នៃមិនថុលនិងអានីកា។'
    },
    ingredients: [
      'Coconut Oil',
      'White Beeswax',
  ...
  },
  {
    ...
    description: {
      ...
      kh: 'ធម្មជាតិក្តៅ។ កំដៅសុខស្រួលនិងបង្កើនការរត់ឈាមសម្រាប់ការស្តារឡើងវិញលឿន។'
    },
    ingredients: [
  ...
  },
  {
    ...
    description: {
      ...
      kh: 'ថាមពលធម្មជាតិ។ ដំណើរការលឿនបំផុតជាមួយអារម្មណ៍ត្រជាក់និងក្តៅ។'
    },
    ingredients: [
      'Coconut Oil',
      'White Beeswax',
  ...
  },
  {
    ...
    description: {
      ...
      kh: 'លាប ម៉ាស្សា ទៅ។ ការលាយប្រេងណាហ្គាបាមដែលមានវីនទ័រហ្គ្រីនពិសេស។'
    },
    ingredients: [
      'Coconut Oil',
      'Oil of Wintergreen',
  ...
  },
  {
    ...
    description: {
      ...
      kh: 'ការបំបាត់ការឈឺចាប់ខ្លាំង។ ការបំបាត់ការឈឺចាប់ធ្ងន់ធ្ងរឬរ៉ាំរ៉ៃជាមួយកំដៅយូរអង្វែង។'
    },
    ingredients: [
      'Chili Infused Coconut Oil',
      'Camphor',
  ...
  },
  {
    ...
    description: {
      ...
      kh: 'បាញ់ លាប ទៅ។ ការបំបាត់ការឈឺចាប់ភ្លាមៗដើម្បីឱ្យអ្នកចល័តបាន។'
    },
    ingredients: [
      'Ethanol',
      'Purified Water',
  ...
  },
  {
    ...
    description: {
      ...
      kh: 'ការបំបាត់ការឈឺចាប់ពីរក្នុងមួយ។ ដំណោះស្រាយបំបាត់ការឈឺចាប់ដោយមិនប៉ះពាល់ពីរក្នុងមួយដើម្បីយកទៅជាមួយ។'
    },
    ingredients: [
  ...
  },
  {
    ...
    description: {
      ...
      kh: 'រីករាយជាមួយជីវិត បណ្តេញមូស។ ថ្នាំកម្ចាត់មូសដែលមានប្រសិទ្ធភាពនិងសុវត្ថិភាពបំផុតនៅកម្ពុជា។'
    },
    ingredients: [
      'Picaridin',
      'Purified Water',
  ...
  },
  {
    ...
    description: {
      ...
      kh: 'រូបមន្តដើម្បីបំបាត់ការចង់ក្អួត ឈឺក្បាល វិលមុខ ស្ទះច្រមុះ ឈឺពោះ និងការឈឺចាប់តិចតួច។'
    },
    ingredients: [
      'Methyl Salicylate',
      'Menthol',
